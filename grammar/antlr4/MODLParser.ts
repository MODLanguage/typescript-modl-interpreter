...
export class MODLParser extends Parser {
  ...
  public modl(): ModlContext {
    let _localctx: ModlContext = new ModlContext(this._ctx, this.state);
  ...
  public modl_structure(): Modl_structureContext {
    let _localctx: Modl_structureContext = new Modl_structureContext(this._ctx, this.state);
  ...
  public modl_map(): Modl_mapContext {
    let _localctx: Modl_mapContext = new Modl_mapContext(this._ctx, this.state);
  ...
  public modl_array(): Modl_arrayContext {
    let _localctx: Modl_arrayContext = new Modl_arrayContext(this._ctx, this.state);
  ...
  public modl_pair(): Modl_pairContext {
    let _localctx: Modl_pairContext = new Modl_pairContext(this._ctx, this.state);
  ...
  public modl_value(): Modl_valueContext {
    let _localctx: Modl_valueContext = new Modl_valueContext(this._ctx, this.state);
  ...
  public modl_primitive(): Modl_primitiveContext {
    let _localctx: Modl_primitiveContext = new Modl_primitiveContext(this._ctx, this.state);
