...
var symbolicNames = [null, "WS", "NULL", "TRUE", "FALSE", "COLON", "EQUALS",
    ...
    "HASH_PREFIX", "LCBRAC", "CWS", "QMARK", "FSLASH",
    "GTHAN", "LTHAN", "ASTERISK", "AMP", "PIPE", "EXCLAM",
    "CCOMMENT", "RCBRAC"];

var ruleNames = ["modl", "modl_structure", "modl_map", "modl_array", "modl_nb_array",
    "modl_pair", "modl_value_item", "modl_top_level_conditional",
    "modl_top_level_conditional_return", "modl_map_conditional",
    "modl_map_conditional_return", "modl_map_item", "modl_array_conditional",
    "modl_array_conditional_return", "modl_array_item", "modl_value_conditional",
    "modl_value_conditional_return", "modl_condition_test",
    "modl_operator", "modl_condition", "modl_condition_group",
    "modl_value", "modl_array_value_item", "modl_primitive"];
    ...
    try {
        ...
        switch (la_) {
            case 1:
                ...
                if ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MODLParser.LBRAC) | (1 << MODLParser.LSBRAC) | (1 << MODLParser.QUOTED) | (1 << MODLParser.STRING) | (1 << MODLParser.LCBRAC))) !== 0)) {
                    this.state = 48;
                    this.modl_structure();
                }
...
MODLParser.prototype.modl_map = function () {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MODLParser.QUOTED) | (1 << MODLParser.STRING) | (1 << MODLParser.LCBRAC))) !== 0)) {
            this.state = 73;
            this.modl_map_item();
            this.state = 78;
            this._errHandler.sync(this);
...
MODLParser.prototype.modl_array = function () {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MODLParser.NULL) | (1 << MODLParser.TRUE) | (1 << MODLParser.FALSE) | (1 << MODLParser.LBRAC) | (1 << MODLParser.LSBRAC) | (1 << MODLParser.NUMBER) | (1 << MODLParser.QUOTED) | (1 << MODLParser.STRING) | (1 << MODLParser.LCBRAC))) !== 0)) {
            this.state = 88;
            this._errHandler.sync(this);
...
MODLParser.prototype.modl_top_level_conditional = function () {
    ...
    try {
        ...
        while (_la === MODLParser.FSLASH) {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            if ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MODLParser.NULL) | (1 << MODLParser.TRUE) | (1 << MODLParser.FALSE) | (1 << MODLParser.EQUALS) | (1 << MODLParser.LBRAC) | (1 << MODLParser.LSBRAC) | (1 << MODLParser.NUMBER) | (1 << MODLParser.QUOTED) | (1 << MODLParser.STRING) | (1 << MODLParser.LCBRAC) | (1 << MODLParser.GTHAN) | (1 << MODLParser.LTHAN) | (1 << MODLParser.EXCLAM))) !== 0)) {
                this.state = 151;
                this.modl_condition_test();
            }
...
MODLParser.prototype.modl_map_conditional_return = function () {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MODLParser.QUOTED) | (1 << MODLParser.STRING) | (1 << MODLParser.LCBRAC))) !== 0));
    } catch (re) {
        if (re instanceof antlr4.error.RecognitionException) {
            localctx.exception = re;
            this._errHandler.reportError(this, re);
...
MODLParser.prototype.modl_array_conditional_return = function () {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MODLParser.NULL) | (1 << MODLParser.TRUE) | (1 << MODLParser.FALSE) | (1 << MODLParser.LBRAC) | (1 << MODLParser.LSBRAC) | (1 << MODLParser.NUMBER) | (1 << MODLParser.QUOTED) | (1 << MODLParser.STRING) | (1 << MODLParser.LCBRAC))) !== 0));
    } catch (re) {
        if (re instanceof antlr4.error.RecognitionException) {
            localctx.exception = re;
            this._errHandler.reportError(this, re);
...
MODLParser.prototype.modl_condition = function () {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if ((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MODLParser.EQUALS) | (1 << MODLParser.GTHAN) | (1 << MODLParser.LTHAN) | (1 << MODLParser.EXCLAM))) !== 0)) {
            this.state = 287;
            this.modl_operator();
        }
